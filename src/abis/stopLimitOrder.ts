export default [
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: 'contract ILimitOrderReceiver', name: 'receiver', type: 'address' },
  ...
  },
  {
    ...
    inputs: [
      { indexed: true, internalType: 'address', name: 'feeTo', type: 'address' },
      { indexed: false, internalType: 'uint256', name: 'externalOrderFee', type: 'uint256' },
    ],
    name: 'LogSetFees',
    type: 'event',
  },
  {
    anonymous: false,
    inputs: [{ indexed: true, internalType: 'contract ILimitOrderReceiver', name: 'receiver', type: 'address' }],
    ...
    inputs: [
      {
        components: [
          ...
          { internalType: 'contract IOracle', name: 'oracleAddress', type: 'address' },
      ...
      { internalType: 'contract ILimitOrderReceiver', name: 'receiver', type: 'address' },
  ...
  {
    inputs: [{ internalType: 'contract ILimitOrderReceiver', name: 'receiver', type: 'address' }],
